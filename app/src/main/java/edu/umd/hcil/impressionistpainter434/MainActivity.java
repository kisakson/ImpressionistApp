...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    private static String[] IMAGE_URLS ={
            ...
            "https://scontent-iad3-1.xx.fbcdn.net/t31.0-8/12696971_10207218183844726_7554019786929248583_o.jpg",
            "https://scontent-iad3-1.xx.fbcdn.net/v/t1.0-9/10897812_10204516867953517_6619392001608893133_n.jpg?oh=5fcac0fa4b7e3b0f50721947a9c6222b&oe=58D1A01C"
    };
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuCircle:
                ...
                return true;
            case R.id.menuDynamicCircle:
                Toast.makeText(this, "Dynamic Circle Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.DynamicCircle);
                return true;
            ...
            case R.id.menuLine:
                ...
                return true;
            case R.id.menuCMSC434Text:
                Toast.makeText(this, "CMSC434 Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.CMSC434Text);
                return true;
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                _impressionistView.setTextBrushValue(in);
                                _impressionistView.setBrushType(BrushType.CustomText);
                            }})
                        .setNegativeButton(android.R.string.cancel, null).show();
                Toast.makeText(this, "Custom Text Brush", Toast.LENGTH_SHORT).show();
                return true;
        }
        return false;
    }
    ...
    /**
     * Saves an image from the drawing canvas into the Gallery
     *
     * @param v
     */
